<?php
	...
	{
		$sql="UPDATE bio SET status='deleted' where id='".$_POST['id']."'";
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">All Bio Graph</a>
                </div>
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM bio WHERE status='published'";  
		...
		?>
                <div style="height:1600px" class="card card-map">
					<div class="header">
                        <h4 class="title">All Bio Graph</h4>
                    </div>
					<div class="map">
					<table class="table table-striped">
						...
						$sql="SELECT * FROM bio where status='published' ORDER BY id ASC LIMIT $start_from, $limit";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
                                        	<td>'.$count.'</td>
                                        	<td>'.$rows['name'].'</td>
                                        	<td><span class="badge badge-success">'.$rows['cat'].'</span></td>
                                        	<td>
											<form action="" method="post">
											<input type="hidden" name="id" value="'.$rows['id'].'">
											<a href="update_bio?id='.$rows['id'].'" class="btn btn-success"><i class="ti-pencil"></i></a> 
