<?php
	...
	{
		$sql="UPDATE search SET status='published' where id='".$_POST['id']."'";
		mysqli_query($conn,$sql);
	}
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM search WHERE status='pending'";  
		...
		?>
                <div style="height:3500px" class="card card-map">
					...
					<table class="table table-striped">
						...
						$sql="SELECT * FROM search where status='pending' ORDER BY id ASC LIMIT $start_from, $limit";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
											...
											<button name="publish" class="btn btn-success"><i class="ti-check"></i></button>
											<button name="delete" class="btn btn-danger"><i class="ti-close"></i></button>
											</form>
											</td>
                                        </tr>';
						}
