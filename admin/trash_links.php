...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM search WHERE status='deleted'";  
		...
		?>
                <div style="height:3500px" class="card card-map">
					...
					<table class="table table-striped">
						...
						$sql="SELECT * FROM search where status='deleted' ORDER BY id ASC LIMIT $start_from, $limit";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
											...
											<button name="delete" class="btn btn-danger">RESTORE</button>
											</form>
											</td>
                                        </tr>';
						}
