<?php
	...
	{
		$sql="UPDATE quick_know SET status='deleted' where id='".$_POST['id']."'";
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM quick_know WHERE status='published' ORDER BY id ASC LIMIT $start_from, $limit";  
		...
		?><div style="height:1600px" class="card card-map">
					...
					<table class="table table-striped">
						...
						$sql="SELECT * FROM quick_know where status='published'";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
											...
											<a href="update_qdata?id='.$rows['id'].'" class="btn btn-success"><i class="ti-pencil"></i></a> 
