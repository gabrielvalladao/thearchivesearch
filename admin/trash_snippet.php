<?php
	...
	{
		$sql="UPDATE snippet SET status='published' where id='".$_POST['id']."'";
...
<head>
	...
	<title>All Trashed Quick Data</title>
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">All Trashed Quick Data</a>
                </div>
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM snippet WHERE status='deleted' ORDER BY id ASC LIMIT $start_from, $limit";  
		...
		?><div style="height:1600px" class="card card-map">
					<div class="header">
                        <h4 class="title">All Trashed Quick Data</h4>
                    </div>
					<div class="map">
					<table class="table table-striped">
						...
						$sql="SELECT * FROM snippet where status='deleted'";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
											...
											<button name="restore" class="btn btn-danger">RESTORE</button> 
											</form>
											</td>
                                        </tr>';
						}
