<?php
	...
	{
		$sql="UPDATE snippet SET status='deleted' where id='".$_POST['id']."'";
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">All Quick Data</a>
                </div>
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM snippet WHERE status='published' ORDER BY id ASC LIMIT $start_from, $limit";  
		...
		?><div style="height:1600px" class="card card-map">
					<div class="header">
                        <h4 class="title">All Quick Data</h4>
                    </div>
					<div class="map">
					<table class="table table-striped">
						...
						$sql="SELECT * FROM snippet where status='published'";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
                                        	<td>'.$count.'</td>
                                        	<td>'.$rows['title_strong'].'</td>
                                        	<td>'.$rows['desc_snippet'].'</td>
                                        	<td>'.$rows['title'].'</td>
                                        	<td>'.$rows['url'].'</td>
                                        	<td>
											<form action="" method="post">
											<input type="hidden" name="id" value="'.$rows['id'].'">
											<a href="update_snippet?id='.$rows['id'].'" class="btn btn-success"><i class="ti-pencil"></i></a> 
