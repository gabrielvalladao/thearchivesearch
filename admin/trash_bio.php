<?php
	...
	{
		$sql="UPDATE bio SET status='published' where id='".$_POST['id']."'";
...
<?php include 'sidebar.php';?>
    ...
    <div class="main-panel">
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">All Trashed Bio Graph</a>
                </div>
		...
		<div class="content">
            <div class="container-fluid">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<?php
			$sql = "SELECT count(id) FROM bio WHERE status='deleted'";  
		...
		?>
                <div style="height:1600px" class="card card-map">
					<div class="header">
                        <h4 class="title">All Trashed Bio</h4>
                    </div>
					<div class="map">
					<table class="table table-striped">
						...
						$sql="SELECT * FROM bio where status='deleted' ORDER BY id ASC LIMIT $start_from, $limit";
						...
						while($rows=mysqli_fetch_assoc($result)){
							$count++;
									...
									echo ' <tr>
											...
											<button name="publish" class="btn btn-danger">RESTORE</button>
											</form>
											</td>
                                        </tr>';
						}
